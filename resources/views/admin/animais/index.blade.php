<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-3">
                <form action="{{ route('animais.index') }}" method="GET">
                    <div class="input-group">
                        <input type="text" class="form-control" name="search" placeholder="Buscar animal">
                    ...
                    @else
                        ...
                        <div class="table-responsive-xl">
                            ...
                            <table class="table table-hover table-striped">
                                ...
                                @if ($animais->isEmpty())
                                    <div class="container text-center" style="margin-top: 45px; margin-bottom: 45px">
                                        <div class="alert" style="font-size: 24px;">Nenhum animal cadastrado...</div>
                                        <a href="{{ route('animais.create') }}" class="btn btn-success">Adicionar
                                            um animal</a>
                                    </div>
                                @else
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($animais as $animal)
                                                ...
                                                <tr>
                                                    <td><b>{{ $animal->nome}}</b> {{' [Proprietário(a): ' . $animal->proprietario->nome . ']'}}</td>
                                                    <td>
                                                        <form
                                                            action="{{ route('animais.destroy', $animal->id) }}"
                                                            method="POST">
                                                            @csrf

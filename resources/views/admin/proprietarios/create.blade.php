        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form class="row g-3" id="form-adicionar" action="{{ route('proprietarios.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            ...
                            <button class="btn btn-success me-md-2" type="submit">Cadastrar proprietário</button>
